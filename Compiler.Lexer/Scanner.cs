    ...
    public class Scanner : IScanner
    {
        ...
        public Scanner(Input input)
        {
            ...
            this.keywords = new Dictionary<string, TokenType>
            {
                ...
                { "list<bool>", TokenType.BoolListKeyword },
                { "string", TokenType.StringKeyword },
                { "list<string>", TokenType.StringListKeyword },
                { "datetime", TokenType.DateKeyword },
                        ...
                        case '+':
                            {
                                ...
                                switch (nextChar)
                                {
                                    case '+':
                                        ...
                                        return new Token
                                        {
                                            TokenType = TokenType.Incremental,
                                            Column = input.Position.Column,
                                            Line = input.Position.Line,
                                            Lexeme = lexeme.ToString()
                                        };
                        ...
                        case '-':
                            {
                                ...
                                switch (nextChar)
                                {
                                    case '-':
                                        ...
                                        return new Token
                                        {
                                            TokenType = TokenType.Decremental,
                                            Column = input.Position.Column,
                                            Line = input.Position.Line,
                                            Lexeme = lexeme.ToString()
                                        };
